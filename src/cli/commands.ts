...
export const COMMANDS: SlashCommand[] = [
    ...
    { name: 'review', tgDescKey: 'cmd.workflow.review.tg_desc', desc: 'Project-dir code review', args: '[--fix] [--dispatch]', category: 'workflow', interfaces: ['cli', 'web', 'telegram', 'discord'], workflow: { kind: 'workflow', phase: 'quality', risk: 'low', output: 'report', workflowArgs: [{ name: 'flags', required: false, kind: 'text' }] }, handler: reviewWorkflowHandler },
    { name: 'goal', descKey: 'cmd.workflow.goal.desc', tgDescKey: 'cmd.workflow.goal.tg_desc', desc: 'Persistent goal and bounded run workflow', args: '<objective> | plan [hint] | [status|run|done|cancel|pause|resume|clear|reset|history]', category: 'workflow', interfaces: ['cli', 'web', 'telegram', 'discord'], workflow: { kind: 'workflow', phase: 'continuation', risk: 'medium', output: 'state', workflowArgs: [{ name: 'objective-or-subcommand', required: false, kind: 'text' }] }, handler: goalWorkflowHandler },
