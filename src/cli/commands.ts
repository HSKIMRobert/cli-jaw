...
export const COMMANDS: SlashCommand[] = [
    ...
    { name: 'review', tgDescKey: 'cmd.workflow.review.tg_desc', desc: 'One-shot code review', args: '[--fix] [--dispatch]', category: 'workflow', interfaces: ['cli', 'web', 'telegram', 'discord'], workflow: { kind: 'workflow', phase: 'quality', risk: 'low', output: 'report', workflowArgs: [{ name: 'flags', required: false, kind: 'text' }] }, handler: reviewWorkflowHandler },
