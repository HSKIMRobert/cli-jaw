...
export const COMMANDS: SlashCommand[] = [
    ...
    { name: 'gd', descKey: 'cmd.workflow.goal.desc', tgDescKey: 'cmd.workflow.goal.tg_desc', desc: 'Mark active goal done (alias for /goal done)', args: '[note] [--force]', category: 'workflow', interfaces: ['cli', 'web', 'telegram', 'discord'], workflow: { kind: 'workflow', phase: 'continuation', risk: 'medium', output: 'state', workflowArgs: [{ name: 'note', required: false, kind: 'text' }] }, handler: gdHandler },
