...
> 현재 `public/`에서 `public/dist/*`를 제외한 소스/자산/legacy duplicate는 490개다. `public/public/dist/*`까지 generated로 보면 실제 편집 대상 소스/자산은 364개다. 생성 산출물은 `public/dist/` 460개와 별도 중복 트리 `public/public/dist/` 127개가 남아 있고, `public/dist/dist/`는 전자에 재귀 포함된 nested 복제본이다.
...
| 영역 | 파일 수 | 비고 |
| --- | ---: | --- |
| `public/` source/assets | 490 | 문서 관례상 `public/dist/*`만 제외, `public/public/dist/*`는 포함 |
